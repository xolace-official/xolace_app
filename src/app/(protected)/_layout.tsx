...
import { StreamOverlayProvider } from "@/src/features/listener-chat/providers/stream-chat-provider";
...
export default function ProtectedLayout() {
  ...
  return (
    ...
    // whole window, header included — see StreamOverlayProvider. Holds no
    // Stream connection; that stays scoped to the thread screen.
