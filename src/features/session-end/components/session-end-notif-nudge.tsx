...
export function SessionEndNotifNudge() {
  ...
  return (
    <EaseView
      animate={{ opacity: show ? 1 : 0, translateY: show ? 0 : height }}
      transition={{ type: 'timing', duration: 440, easing: [0.25, 0.1, 0.25, 1] }}
    ...
    >
      <View className="flex-1 px-6 justify-between">
        ...
        <View className="gap-3">
          ...
          >
            <AppText className="text-base font-semibold text-accent">Remind me</AppText>
          </PressableFeedback>
          <PressableFeedback
            onPress={handleLater}
          ...
          >
            <AppText className="text-base font-light text-foreground/30">Maybe later</AppText>
          </PressableFeedback>
        </View>
      </View>
    </EaseView>
