/**
 * The four offers on the intake deck, each drawn as the thing itself rather
 * than as an illustration of it: the voice card really plays the voices, the
 * others are miniatures of the surfaces they unlock.
 *
