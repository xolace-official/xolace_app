...
const ENTRIES: Entry[] = [
  ...
  // PROTOTYPE (#396): Library entry point, per #393 — the 4th Browse button.
  { id: 'lantern', label: 'Lantern', icon: { ios: 'book', android: 'menu_book', web: 'menu_book' }, bg: 'bg-browse-topics', fg: '--color-browse-topics-foreground', href: '/browse/library-prototype' },
];
